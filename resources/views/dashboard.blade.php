...
<div id="verify-modal" class="fixed inset-0 bg-black/50 flex justify-center items-center animate-fade-in">
    <div class="bg-white p-6 rounded shadow max-w-sm text-center space-y-4 dark:bg-gray-800 dark:text-white">
        <h2 class="text-xl font-bold text-red-600">Email non vérifié</h2>
        <p class="text-gray-700 dark:text-gray-400">Merci de vérifier votre email pour activer votre compte.</p>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg dark:bg-gray-800">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex items-center justify-between">
                        ...
                        <button data-modal="createProject" class="modal-open flex items-center gap-2 px-3 py-2 bg-secondaire text-white rounded shadow-sm hover:shadow-lg dark:text-white dark:bg-secondaire/80 dark:hover:bg-secondaire/90 transition">
