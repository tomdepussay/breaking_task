<div class="modal-container">
    <div class="modal-header">
        <p class="modal-title">Modifier la catégorie : <span class="text-gray-800 font-bold">{{ $category->name }}</span></p>
    ...
    <div class="modal-content">
        <form action="" id="editCategoryForm">
            <div class="flex flex-col gap-2">
                ...
                <input class="rounded" type="text" name="name" id="name" autocomplete="off" value="{{ $category->name }}">
            </div>
        </form>
    </div>
